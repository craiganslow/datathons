...
%}
\alignauthor
Craig Anslow$^1$, John Brosz$^2$, Frank Maurer$^1$, Mike Boyes$^3$\\
       \affaddr{$^1$Department of Computer Science, $^2$Libraries \& Cultural Resources, $^3$Department of Pyschology}\\
       \affaddr{University of Calgary, }\\
       \affaddr{Calgary, Alberta, Canada}\\
       \email{\{canslow,jdlbrosz,fmaurer,boyes\}@ucalgary.ca}   
}
...
\begin{abstract}
Hosting successful hackathons is difficult. With the accessibility of open data there is now an opportunity to host hackathons focused on big data, however these are new and not clearly defined about how to do this process. In this paper we present our experience at hosting four big data hackathons called \emph{datathons} that involved students and members from the community coming together to solve challenging problems with publicly open data and data from not for profits. The resources developed for our datathons about our experience will help inform others who also wish to host big data hackathons.
\end{abstract}
...
\keywords{Big Data, Data Science, Hackathon, Open Data}
